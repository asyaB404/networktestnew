...
namespace FishNet.Connection
{
    ...
    public partial class NetworkConnection : IResettable, IEquatable<NetworkConnection>
    {
        ...
        public void SetFirstObject(NetworkObject nob)
        {
            ...
            {
                string errMessage =
                    $"FirstObject for {ClientId} cannot be set to {nob.name} as it's not within Objects for this connection.";
        ...
        public bool Equals(NetworkConnection nc)
        {
            if (nc is null)
                return false;
            //If either is -1 Id.
            if (this.ClientId == NetworkConnection.UNSET_CLIENTID_VALUE ||
                nc.ClientId == NetworkConnection.UNSET_CLIENTID_VALUE)
                return false;
            //Same object.
        ...
        public override string ToString()
        {
            ...
            string ip = (NetworkManager != null)
                ? NetworkManager.TransportManager.Transport.GetConnectionAddress(clientId)
                : "Unset";
